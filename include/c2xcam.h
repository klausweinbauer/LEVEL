...
int SHARED_EXPORT setCAMHeader(int id, int protocolVersion, int messageID, 
    unsigned int stationID);
int SHARED_EXPORT setCAMGenerationDeltaTime(int id, int generationDeltaTime);
int SHARED_EXPORT setCAMBasicContainer(int id, int stationType, 
    Position position);

int SHARED_EXPORT setCAMBasicVehicleContainerHighFrequency(int id,
...
int SHARED_EXPORT setCAMBasicVehicleContainerHighFrequencyLanePosition(int id,
    int lanePosition);
...
int SHARED_EXPORT setCAMBasicVehicleContainerHighFrequencyPerformaceClass(
...
int SHARED_EXPORT getCAMHeader(int id, int *protocolVersion, 
    int *messageID, unsigned int *stationID);
int SHARED_EXPORT getCAMHeader_recv(int stationId, int *protocolVersion, 
    int *messageID, unsigned int *stationID);
int SHARED_EXPORT getCAMGenerationDeltaTime(int id, 
    int *generationDeltaTime);
int SHARED_EXPORT getCAMGenerationDeltaTime_recv(int stationId, 
    int *generationDeltaTime);
int SHARED_EXPORT getCAMBasicContainer(int id, int *stationType, 
    Position *position);
int SHARED_EXPORT getCAMBasicContainer_recv(int stationId, int *stationType, 
    Position *position);

int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequency(int id,
    int *headingValue, int *headingConfidence,
    int *speedValue, int *speedConfidence,
    int *driveDirection,
    int *vehicleLengthValue, int *vehicleLengthConfidenceIndication,
    ...
    int *curvatureCalculationMode,
    int *yawRateValue, int *yawRateConfidence);
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequency_recv(int stationId,
    int *headingValue, int *headingConfidence,
    int *speedValue, int *speedConfidence,
    int *driveDirection,
    int *vehicleLengthValue, int *vehicleLengthConfidenceIndication,
...
int SHARED_EXPORT 
    getCAMBasicVehicleContainerHighFrequencyAccelerationControl_recv(
    int id,
    uint8_t *buffer, int size, int* actualSize);
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequencyLanePosition(int id,
    int *lanePosition);
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequencyLanePosition_recv(
    int id, int *lanePosition);
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequencySteeringWheelAngle(
    int id,
    int *steeringWheelAngleValue, int *steeringWheelAngleConfidence);
int SHARED_EXPORT 
    getCAMBasicVehicleContainerHighFrequencySteeringWheelAngle_recv(
...
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequencyLateralAcceleration(
    ...
    int *lateralAccelerationValue, int *lateralAccelerationConfidence);
int SHARED_EXPORT 
    getCAMBasicVehicleContainerHighFrequencyLateralAcceleration_recv(int id,
    int *lateralAccelerationValue, int *lateralAccelerationConfidence);
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequencyVerticalAcceleration(
    int id,
    int *verticalAccelerationValue, int *verticalAccelerationConfidence);
int SHARED_EXPORT 
    getCAMBasicVehicleContainerHighFrequencyVerticalAcceleration_recv(int id,
    int *verticalAccelerationValue, int *verticalAccelerationConfidence);
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequencyPerformaceClass(
    int id, int *performanceClass);
int SHARED_EXPORT 
    getCAMBasicVehicleContainerHighFrequencyPerformaceClass_recv(int id, 
...
int SHARED_EXPORT getCAMBasicVehicleContainerHighFrequencyCenDsrcTollingZone(
    ...
    int *cenDsrcTollingZoneID);
int SHARED_EXPORT 
    getCAMBasicVehicleContainerHighFrequencyCenDsrcTollingZone_recv(int id,
    int *protectedZoneLatitude, int *protectedZoneLongitude, 
    int *cenDsrcTollingZoneID);
#pragma endregion
