classdef SetDENMRoadWorksContainerExtendedSpeedLimit < matlab.System & coder.ExternalDependency
    ...
    methods (Access = protected)
        ...
        function [] = stepImpl(obj, StationID, SequenceNumber, SpeedLimit)
            if coder.target('Rtw') || coder.target('Sfun') 
                err = int32(0);
                coder.cinclude('c2xdenm.h');
                err = coder.ceval('setDENMRoadWorksContainerExtendedSpeedLimit', StationID, SequenceNumber, int32(SpeedLimit));
    ...
    methods (Static)
        function bName = getDescriptiveName(~)
            bName = 'SetDENMRoadWorksContainerExtendedSpeedLimit';
        end
