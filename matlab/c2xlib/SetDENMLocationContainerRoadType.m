classdef SetDENMLocationContainerRoadType < matlab.System & coder.ExternalDependency
    ...
    methods (Access = protected)
        ...
        function [] = stepImpl(obj, StationID, SequenceNumber, RoadType) 
            if coder.target('Rtw') || coder.target('Sfun') 
                err = int32(0);
                coder.cinclude('c2xdenm.h');
                err = coder.ceval('setDENMLocationContainerRoadType', StationID, SequenceNumber, RoadType);
    ...
    methods (Static)
        function bName = getDescriptiveName(~)
            bName = 'SetDENMLocationContainerSpeed';
        end
