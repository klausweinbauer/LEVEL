    ...
    methods (Access = protected)
        ...
        function [VerticalAccelerationValue, VerticalAccelerationConfidence] = stepImpl(obj, StationID) 
            if coder.target('Rtw') || coder.target('Sfun') 
                coder.ceval('getCAMBasicVehicleContainerHighFrequencyVerticalAcceleration', StationID, coder.wref(VerticalAccelerationValue), coder.wref(VerticalAccelerationConfidence));
            end            
        end
