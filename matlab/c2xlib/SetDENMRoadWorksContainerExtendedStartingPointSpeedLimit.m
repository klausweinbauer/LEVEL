classdef SetDENMRoadWorksContainerExtendedStartingPointSpeedLimit < matlab.System & coder.ExternalDependency
    ...
    methods (Access = protected)
        ...
        function [] = stepImpl(obj, StationID, SequenceNumber, DeltaLatitude, DeltaLongitude, DeltaAltitude)
    ...
    methods (Static)
        function bName = getDescriptiveName(~)
            bName = 'SetDENMRoadWorksContainerExtendedStartingPointSpeedLimit';
        end
