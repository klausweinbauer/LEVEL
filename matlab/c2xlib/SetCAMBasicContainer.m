    ...
    methods (Access = protected)
        ...
        function [] = stepImpl(obj, StationID, StationType, Latitude, Longitude, ConfidenceMajor, ConfidenceMinor, ConfidenceMajorOrientation, AltitudeValue, AltitudeConfidence) 
            if coder.target('Rtw') || coder.target('Sfun') 
                coder.ceval('setCAMBasicContainer', StationID, StationType, Latitude, Longitude, ConfidenceMajor, ConfidenceMinor, ConfidenceMajorOrientation, AltitudeValue, AltitudeConfidence);
            end            
        end
