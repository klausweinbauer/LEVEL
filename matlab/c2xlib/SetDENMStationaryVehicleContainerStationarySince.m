classdef SetDENMStationaryVehicleContainerStationarySince < matlab.System & coder.ExternalDependency
    ...
    methods (Access = protected)
        ...
        function [] = stepImpl(obj, StationID, SequenceNumber, StationarySince)
            if coder.target('Rtw') || coder.target('Sfun') 
                err = int32(0);
                coder.cinclude('c2xdenm.h');
                err = coder.ceval('setDENMStationaryVehicleContainerStationarySince', StationID, SequenceNumber, int32(StationarySince));
