classdef GetDENMStationaryVehicleContainerEnergyStorageType < matlab.System & coder.ExternalDependency
    ...
    methods (Static)
        function bName = getDescriptiveName(~)
            bName = 'GetDENMStationaryVehicleContainerEnergyStorageType';
        end
